...
//go:generate go tool github.com/siderolabs/deep-copy -type LVMLogicalVolumeSpecSpec -type LVMLogicalVolumeStatusSpec -type LVMPhysicalVolumeSpecSpec -type LVMPhysicalVolumeStatusSpec -type LVMRefreshRequestSpec -type LVMValidationErrorSpec -type LVMVolumeGroupSpecSpec -type LVMVolumeGroupStatusSpec -type MDArraySpecSpec -type MDArrayStatusSpec -type MDRefreshRequestSpec -type MDStartupStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go .
